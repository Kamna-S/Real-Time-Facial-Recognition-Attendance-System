...
class Face_Recognition_System:
    def __init__(self, root):
        ...
        # First Image
        img = Image.open(r"C:\Users\Harish Mandal\Desktop\pythonProject13\images\facial-recognition_0.jpg")
        img = img.resize((600,100), Image.LANCZOS)  # Adjusted width to 400
        ...
        img1 = img1.resize((600, 100), Image.LANCZOS)  # Adjusted width to 400
        ...
        # Third Image
        img2 = Image.open(r"C:\Users\Harish Mandal\Desktop\pythonProject13\images\1_DcfASWnmSujocQ_5X7OZ3Q.png")
        img2 = img2.resize((600, 100), Image.LANCZOS)  # Adjusted width to 400
        self.photoimg2 = ImageTk.PhotoImage(img2)

        f_lbl = Label(self.root, image=self.photoimg2)
        f_lbl.place(x=800, y=0, width=600, height=100)

        # background image
        img3 = Image.open( r"C:\Users\Harish Mandal\Desktop\pythonProject13\images\Background-PNG-Isolated-Pic.png")
        img3 = img3.resize((1280, 580), Image.LANCZOS)
        ...
        # Text
        title_lbl = Label(bg_img, text="STUDENT MANAGEMENT SYSTEM", font=("times new roman", 20, "bold"),
                          bg="white", fg="red")
        title_lbl.place(x=0, y=0, width=1280, height=30)

        main_frame = Frame(bg_img, bd=2)
        main_frame.place(x=10, y=35, width=1260, height=530)

        # Left label frame
        left_frame = LabelFrame(main_frame, bd=2, bg="white", relief=RIDGE, text="Student Details",
                                font=("times new roman", 10, "bold"))
        left_frame.place(x=10, y=10, width=700, height=510)
        ...
        current_course_frame = LabelFrame(left_frame, bd=2, bg="white", relief=RIDGE, text="Current Course Information",
                                          font=("times new roman", 10, "bold"))
        current_course_frame.place(x=5, y=115, width=590, height=100)

        # Department
        dep_label = Label(current_course_frame, text="Department", font=("times new roman", 10, "bold"))
        dep_label.grid(row=0, column=0)

        dep_combo = ttk.Combobox(current_course_frame, textvariable=self.var_dep, font=("times new roman", 10, "bold"), width=15)
        dep_combo["values"] = ("Select Department", "AI AND DS", "CS")
        dep_combo.current(0)
        ...
        course_combo = ttk.Combobox(current_course_frame,textvariable=self.var_course,font=("times new roman", 10, "bold"), state="readonly",
                                    width=15)
        course_combo["values"] = ("Select Course", "Advance AI", "AI FOR CS", "CS")
        ...
        class_student_frame = LabelFrame(left_frame, bd=2, bg="white", relief=RIDGE, text="Class Student Information",
                                         font=("times new roman", 10, "bold"))
        class_student_frame.place(x=5, y=225, width=800, height=325)  # Adjusted the y-coordinate
        ...
        # Student Division
        student_div_label = Label(class_student_frame, text="Student Division", font=("times new roman", 10, "bold"),
                                  bg="white")
        student_div_label.grid(row=1, column=0, padx=10, pady=5, sticky=W)

        #student_div_entry = ttk.Entry(class_student_frame,textvariable=self.var_div, width=20, font=("times new roman", 10, "bold"))
        #student_div_entry.grid(row=1, column=1, padx=10, pady=5, sticky=W)
        
        student_div_combo = ttk.Combobox(class_student_frame,textvariable=self.var_div, font=("times new roman", 10, "bold"), state="readonly",
                                  width=10)
        student_div_combo["values"] = ("AI AND DS","CS")
        student_div_combo.current(0)
        student_div_combo.grid(row=1, column=1, padx=10, pady=5, sticky=W)
        # Roll no
        student_roll_label = Label(class_student_frame, text="Roll no", font=("times new roman", 10, "bold"), bg="white")
        student_roll_label.grid(row=1, column=2, padx=10, pady=5, sticky=W)

        student_roll_entry = ttk.Entry(class_student_frame,textvariable=self.var_roll, width=20, font=("times new roman", 10, "bold"))
        ...
        # Teacher name
        teacher_label = Label(class_student_frame, text="Teacher", font=("times new roman", 10, "bold"), bg="white")
        ...
        # Radio button
        self.var_radio1 = StringVar()
        radiobutton1 = Radiobutton(class_student_frame, variable=self.var_radio1,text="Take Photo Sample", value="Yes",
                                   font=("times new roman", 10, "bold"), background="white")
        radiobutton1.grid(row=6, column=0, padx=10, pady=5, sticky=W)

      
        radiobutton2 = Radiobutton(class_student_frame, variable=self.var_radio1,text="No Photo Sample", value="No",
                                   font=("times new roman", 10, "bold"), background="white")
        radiobutton2.grid(row=6, column=1, padx=10, pady=5, sticky=W)

        #button frame
        btn_frame = Frame(class_student_frame, bd=2, relief=RIDGE, bg="white")
        btn_frame.place(x=0, y=200, width=590, height=35)

        # Save Button
        save_btn = Button(btn_frame, text="Save",command=self.add_data, width=12,font=("times new roman", 13, "bold"), bg="blue",
                          fg="white")
        save_btn.grid(row=0, column=0, padx=10, pady=5)

        # Update Button
        update_btn = Button(btn_frame, text="Update",command=self.update_data, width=12, font=("times new roman", 13, "bold"),
                            bg="blue", fg="white")
        update_btn.grid(row=0, column=1, padx=10, pady=5)

        # Delete Button
        delete_btn = Button(btn_frame, text="Delete", command=self.delete_data, width=12, font=("times new roman", 13, "bold"),
                            bg="blue", fg="white")
        delete_btn.grid(row=0, column=2, padx=10, pady=5)

        # Reset Button
        reset_btn = Button(btn_frame, text="Reset", command=self.reset_data, width=12, font=("times new roman", 13, "bold"), bg="blue",
                           fg="white")
        reset_btn.grid(row=0, column=3, padx=10, pady=5)

        btn_frame1=Frame(class_student_frame,bd=2,relief=RIDGE,bg="white")
        btn_frame1.place(x=0,y=235,width=590,height=35)

        # right frame
        right_frame = LabelFrame(main_frame, bd=2, bg="white", relief=RIDGE, text="Student Details",
                                 font=("times new roman", 12, "bold"))
        right_frame.place(x=620, y=10, width=700, height=580)

        img_right = Image.open(r"C:\Users\Harish Mandal\Desktop\pythonProject13\images\images.jpeg")
        ...
        show_all = Button(search_frame, text="Show All", width=10, font=("times new roman", 13, "bold"), bg="blue",
                           fg="white")
        show_all.grid(row=0, column=4, padx=4, pady=5)

        table_frame=Frame(right_frame,bd="2",bg="white",relief=RIDGE)
        table_frame.place(x=5,y=199,width=600,height=200)
        ...
        take_photo_btn.pack(side="left", padx=5)  # Use pack for left alignment

        # Update Photo Button
        update_photo_btn = Button(btn_frame, text="Update Photo Sample", width=30,
                                  font=("times new roman", 13, "bold"),
                                  bg="blue", fg="white")
        update_photo_btn.pack(side="left", padx=5)  # Use pack for left alignment

        # Adjust the coordinates for the btn_frame
        btn_frame.place(x=0, y=400, width=605, height=35)
                ...
                if Update > 0:
                    ...
                    cursor.execute(
                        ...
                        (
                            ...
                            self.var_address.get(),
                            self.var_teacher.get(),
                            self.var_radio1.get(),  # Use the correct variable name here
                            self.var_id.get()
                        )
                    )
                else:
...
#opencv          
                ...
                face_classifier=cv2.CascadeClassifier("C:/Users/Harish Mandal/Desktop/pythonProject13/haarcascade_frontalface_default.xml")
                ...
                while True:
                    ...
                    if face_cropped(my_frame) is not None:
                        ...
                        file_name_path="storage/user."+str(id)+"."+str(img_id)+".jpg"
